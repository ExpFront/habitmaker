...
const MainPage: FC = () => {
  ...
  <div className="col-8 alert alert-warning bg-warning border-0 alert-dismissible fade show"
  role="alert">
    <p>
      {store.isAuth ? `Пользователь авторизован ${store.user.email}` : 'АВТОРИЗУЙТЕСЬ'}
      <br />
      {store.user.isActivated ? 'Аккаунт подтвержден по почте' : 'Подтвердите почту!'}
    </p>
  <button
    type="button"
    className="btn-close"
          ...
          <div className="row">
            ...
            <div className="col-12">
              <div className="card">
                ...
                <div className="card-body">
                  <h5 className="card-title">
                    Эффективность привычек <span>/Сегодня</span>
                  </h5>
                  {/* Line Chart */}
                  <div id="reportsChart" />
                  {/* End Line Chart */}
